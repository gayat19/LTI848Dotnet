...
namespace CollectionExampleProject
{
    class Program
    {
        ...
        void UnderstandingStack()
        {
            ...
            names.Push("Bimu");
            names.Push("Pomu");
            Console.WriteLine("Please enter a name to b e inserted");
            ...
            //peek will not pop
            Console.WriteLine("Peeking in to check the next item to be poped -----"+names.Peek());
        ...
        void UnderstandingQueue()
        {
            ...
            students.Enqueue(new Student(101, "Ramu"));
            ...
            Console.WriteLine("---------------------------------------");
            Console.WriteLine("Items after tge deququ in queue are");
            foreach (Student stu in students)
            {
                Console.WriteLine(stu);
            }
        ...
        void UsingStudentLinkedList()
        {
            ...
            students.AddFirst(new Student(101, "Ramu"));
            students.AddLast(new Student(102, "Somu"));
            Student s = new Student(101, "Ramu");
        ...
        {
            int num1 = 10, num2 = 10;
            string str1 = "Ramu", str2 = "Ramu";
            Student student1 = new Student(101, "Ramu");
            Student student2 = new Student(101, "Ramu");
            //if (student1.Id == student2.Id && student2.Name == student1.Name)//compare the whatever
        ...
        void UnderstandingSort()
        {
            ...
            students.Add(new Student(105, "Bimu"));
            students.Add(new Student(102, "Komu"));
            students.Add(new Student(104, "Lomu"));
            Console.WriteLine("Original order");
        ...
        void UnderstandingHashSet()
        {
            ...
            if(students.Contains(new Student(103, "Somu")))
            ...
            stuList.Sort();
            //removing the data
            students.Remove(new Student(101, "Ramu"));
        ...
        void UnderstandingDictionary()
        {
            ...
            myDictionary.Add(10, "Ramu");
            myDictionary.Add(56, "Somu");
            myDictionary.Add(9, "Ramu");
            myDictionary.Add(11, null);
            if(!myDictionary.ContainsKey(10))
                myDictionary.Add(10, "Komu");
            //access a member of a dictionary
            myDictionary[30] = "Dimu";
        ...
        {
            new Program().UnderstandingHashTable();
            Console.ReadKey();
        }
    }
